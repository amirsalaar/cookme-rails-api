...
ActiveRecord::Schema.define(version: 2019_06_04_003800) do
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["food_id"], name: "index_taggings_on_food_id"
    t.index ["ingredient_id"], name: "index_taggings_on_ingredient_id"
  end
  ...
  add_foreign_key "taggings", "foods"
  add_foreign_key "taggings", "ingredients"
end
